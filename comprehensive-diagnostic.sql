-- Comprehensive diagnostic for booking issues
...
-- 2. Check if the user has a profile record
SELECT 
...
-- 4. Check the actual schema of profiles table
SELECT 
...
-- 5. Check the actual schema of bookings table
SELECT 
...
-- 6. Create a profile record if it doesn't exist
DO $$
DECLARE
  user_exists BOOLEAN;
...
-- 7. Test a simple booking insert
DO $$
DECLARE
  hotel_uuid UUID;
