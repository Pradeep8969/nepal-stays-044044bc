-- Fix admin booking query - handle missing profiles and create test data
...
-- 3. Show booking users who need profiles
SELECT 
...
-- 4. Create profiles for all booking users who don't have them
DO $$
DECLARE
  user_record RECORD;
BEGIN
